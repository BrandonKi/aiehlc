module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  func.func @routing(%arg0: !emitc.ptr<!emitc.opaque<"XAie_DevInst">>, %arg1: memref<16x64xi32>, %arg2: memref<64x16xi32>, %arg3: memref<16x16xi32>) {
    ...
    %2 = bufferization.to_tensor %arg2 : memref<64x16xi32>
    %3 = routing.routingcreatescheduletensor %2 : tensor<64x16xi32> shape = [64, 16], dim = 2 -> tensor<64x16xi32>
    %4 = bufferization.to_tensor %arg3 : memref<16x16xi32>
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %8 = routing.routingextract_data %6, %arg4 : tensor<64x16xi32>, i32 -> tensor<64x16xi32>
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %9 = routing.routingextract_data %6, %arg4 : tensor<16x64xi32>, i32 -> tensor<16x64xi32>
        ...
        dmaphop.sync %18
        %19 = routing.routingextract_data %7, %arg4 : tensor<16x16xi32>, i32 -> tensor<16x16xi32>
