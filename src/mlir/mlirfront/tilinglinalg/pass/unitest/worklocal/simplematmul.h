...
#include <stdio.h>
#include <stdlib.h>
// GEMM dimensions — use #ifndef so sim files can override with smaller values.
// NOTE: Keep M, K, N as multiples of (HW_ROWS * d1.size) = 4*16 = 64.
#ifndef M
#define M 128
#endif
#ifndef K
...
// HW mesh dimensions — also overridable for sim.
#ifndef HW_ROWS
#define HW_ROWS 4
#endif
#ifndef HW_COLS
